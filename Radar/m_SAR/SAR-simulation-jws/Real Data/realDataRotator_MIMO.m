...
iParams.scanName = "rotatorTest12";
iParams.CSAR = true;
iParams.MIMO = true;
...
[rImage_MIMO,x2,y2,z2] = resizeP(csarImage,x,y,z,p);

volumeViewer(rImage_MIMO)

%% Saving the volumetric data

save knifeCSAR_MIMO rImage_MIMO config_MIMO_VR config_MIMO_MIP

%% Use volshow and configs
vr = figure('OuterPosition',[695 166 670 712]);
volshow(rImage_MIMO,config_MIMO_VR);

mip = figure('OuterPosition',[695 166 670 712]);
volshow(rImage_MIMO,config_MIMO_MIP);

%% Save Figures

saveas(vr,'./Real Images/knife_MIMO_vr.jpg');
saveas(mip,'./Real Images/knife_MIMO_mip.jpg');

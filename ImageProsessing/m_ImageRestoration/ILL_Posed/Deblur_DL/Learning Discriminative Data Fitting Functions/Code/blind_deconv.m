function [kernel, interim_latent] = blind_deconv(y, lambda_grad, weights_filters, parameter_p, filters, opts)
% 
...
for s = num_scales:-1:1
  ...
  [ks, lambda_grad, interim_latent] = blind_deconv_main(ys, ks, lambda_grad, weights_filters, parameter_p, filters, opts);
   %% center the kernel

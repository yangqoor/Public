function [k,ex,ssde]=deconv_smp_filt_sps(y,k_sz1,k_sz2,x,sig_noise,bmp_outname,dispOn,edges_w)
%function [k,ex,ssde]=deconv_smp_filt_sps(y,k_sz1,k_sz2,x,sig_noise,bmp_outname,dispOn,edges_w)
...
%To approximate the covariance we use the sampling algorithm of
%Levi and Weiss. Note that this is a very slow algorithm..    
%
%input arguments:
% y- blurred image

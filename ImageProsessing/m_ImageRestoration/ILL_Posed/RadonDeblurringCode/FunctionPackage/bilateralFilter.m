...
function output = bilateralFilter( data, edge, edgeMin, edgeMax, sigmaSpatial, sigmaRange, spatKernelSize, ...
    samplingSpatial, samplingRange )
...
if ~exist( 'spatKernelSize', 'var' ),
    spatKernelSize = 6*sigmaSpatial+1;
    fprintf( 'Using default spatKernelSize of: %f\n', spatKernelSize );
end
...
kernelWidth = spatKernelSize;%kevin's implementation -> 2 * derivedSigmaSpatial + 1;

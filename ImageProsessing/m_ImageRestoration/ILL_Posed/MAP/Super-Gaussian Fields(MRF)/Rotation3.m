function [w,u]=Rotation3(x,xcov,pis,prob,orthVect,j)
...
xs = im2col(x, [3,3], 'sliding');
% Kwhiten=whiteningFilter(xs',[3 3]);
% basis1=makeBasis(Kwhiten,1);
Kwhiten=equivalentFilter(prob.J,[3,3]);
basis1=makeBasis(Kwhiten,1);

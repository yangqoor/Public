...
if nkdims == 3
	% text axis labels
	xlabel('$\theta_X$','Color','black','Interpreter','LaTeX');
	ylabel('$\theta_Y$','Color','black','Interpreter','LaTeX');
	zlabel('$\theta_Z$','Color','black','Interpreter','LaTeX')
else
	if sdims(1)
		xlabel('$\theta_X$','Color','black','Interpreter','LaTeX');
		ylabel('$\theta_Z$','Color','black','Interpreter','LaTeX');
	elseif sdims(2)
		xlabel('$\theta_Y$','Color','black','Interpreter','LaTeX');
		ylabel('$\theta_Z$','Color','black','Interpreter','LaTeX');
	elseif sdims(3)
		xlabel('$\theta_Y$','Color','black','Interpreter','LaTeX');
		ylabel('$\theta_X$','Color','black','Interpreter','LaTeX');
	end
end
if ~friendly

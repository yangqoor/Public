function [zro,diso,alf]=Tikh_reg_discr(KK1,ud1,h,delta,C)
...
iz=min(find(Dis<=C*Del+0.001*Nz/norm(ud1)));alf=Alf(iz);
[zro,diso,vo]=Tikh_alf1(KK1,ud1,h,delta,alf);
%figure(101);plot(log10(Alf),Dis, 'r.-',log10(Alf),C*Del+0.001*Nz,'k-',...
%   log10(Alf(iz)),Dis(iz),'bo');

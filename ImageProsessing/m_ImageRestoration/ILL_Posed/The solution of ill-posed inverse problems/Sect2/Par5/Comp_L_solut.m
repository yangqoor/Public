...
% Нахождение L-псевдорешений с помощью синг. разложений (с.78)

clear all;close all

disp(' ');disp('  Нахождение L-псевдорешений разных типов для интегрального уравнения.');
...
[xxa,yya]=kriv(log10(Dis),log10(Nzw));%xxa=xxa+1;

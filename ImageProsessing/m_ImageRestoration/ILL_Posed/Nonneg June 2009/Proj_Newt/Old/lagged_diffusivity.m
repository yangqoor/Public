...
%  This m-file is an implimentation of the Lagged Diffusivity Iteration 
%  for total variation regularized least squares.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  while outer_flag == 0;
    ...
    x_new = x_c + delx;  
    %[x_new,phi_alpha,g_alpha,cost_params,ls_flag] = ... 
    %        linesrch_quad_uncon(x_c,delx,g_c,J_c,cost_fn,cost_params,opt_p
    %        arams,1)

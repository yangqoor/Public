  function [x,iter_hist,term_code] = cg_paramselect(x0,b,params,a_mult,precond);

%  function [x,iter_hist,term_code] = cg(x0,b,params,a_mult,precond);

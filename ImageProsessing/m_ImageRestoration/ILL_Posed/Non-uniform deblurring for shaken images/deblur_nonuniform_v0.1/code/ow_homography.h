...
__inline__ void compute_homography_matrix(const double *Ksharp, const double *theta, const double *invKblurry, double *H) {
	double R[9];
	/* Compute homography */
	cp3(invKblurry,H);
...
__inline__ void compute_prerotated_homography_matrix(const double *Ksharp, const double *theta, const double *theta_pre, const double *invKblurry, double *H) {
	double R[9];
	/* Compute homography */
	cp3(invKblurry,H);
	rot3(theta[0],theta[1],theta[2],R);
...
__inline__ void project_blurry_to_sharp(const int yi, const int xi, const double *H, double *xjptr, double *yjptr) {
...
__inline__ void interp_coeffs(const double xj, const double yj, int *xjfloorptr, int *yjfloorptr, double *coeffs) {

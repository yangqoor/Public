...
class eval15_gamma(srdata.SRData):
    def __init__(self, args, name='eval15_gamma', train=False, benchmark=False):
        super(eval15_gamma, self).__init__(
            args, name=name, train=train, benchmark=benchmark
        )

    def _scan(self):#use this
        # print('use _scan_gamma')
        names_hr, names_lr = super(eval15_gamma, self)._scan()
        #print('read eval')
    ...
    def _set_filesystem(self, dir_data): #use this
        ...
        super(eval15_gamma, self)._set_filesystem(dir_data)

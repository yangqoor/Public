...
% draw center point on gived mat from depth vec
    ...
    for pvec_idx = 1:ProInfo.RANGE_HEIGHT*ProInfo.RANGE_WIDTH
        ...
        w_cam_old = round(x_cam_old) - CamInfo.cam_range(1,1) + 1;
        h_cam_old = round(y_cam_old) - CamInfo.cam_range(2,1) + 1;
        w_cam_new = round(x_cam_new) - CamInfo.cam_range(1,1) + 1;
        h_cam_new = round(y_cam_new) - CamInfo.cam_range(2,1) + 1;

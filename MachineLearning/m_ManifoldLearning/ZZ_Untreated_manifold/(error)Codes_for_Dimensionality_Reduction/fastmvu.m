...
% Maastricht University, 2007
    ...
    blocks = components(D)';
    if max(blocks) > 1
        error('The neighborhood graph is not connected, causing a maximization of a function without upper bound. Try a higher value of k or adaptive neighborhood selection.');
    end
    clear blocks

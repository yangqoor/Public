                ...
                if(~flag_consecutive_bg)
                    ...
                    for start_fr_num = 1:1:L_M-L_dash+1
                        for act_num = 1:num_of_actions
                            ...
                            % WRITE CODE TO STORE VARIOUS DISTANCES FOR
                            % ACTION LABELS FRAME
                        end
                    end
...
%             end
    ...
    if(flag_full_seq)
        results_filename = sprintf('Results_Phase3_Action_PredictionAccuracy_Run%d_CRBMSizes_%d_nt_%d_fullseq_UCF_PercentCompletion.mat',rr,opts_crbm_per_action{1}.sizes(1),opts_crbm_per_action{1}.n{1});

...
%                 action_detected = (~predicted_label);
                ...
                fprintf('Finished testing window %d out of %d of seq %d-%d\n',win_count,length(L:L_shift:num_of_test_frames),seq_row,seq_num);
    ...
    results_filename = sprintf('Results_Phase3_Action_Classification_Run-%d_UCF.mat',rr);

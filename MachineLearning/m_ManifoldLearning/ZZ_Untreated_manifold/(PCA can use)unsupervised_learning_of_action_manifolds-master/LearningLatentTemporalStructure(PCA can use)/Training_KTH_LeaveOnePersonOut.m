...
opts_auto.numepochs = 100; % Optimum value
opts_auto.sizes = [100 60]; % Optimum Value
...
%             Size(ce) = size(TrainingData{ce},1);
    ...
    sae_filename = sprintf('SAE_Workspace_Run%d_LOOP.mat',rr);
    ...
    clusters_filename = sprintf('Cluster_Workspace_Run%d_LOOP.mat',rr);
    ...
    crbm_filename = sprintf('CRBM_Workspace_Run%d_LOOP.mat',rr);
    ...
    svm_filename = sprintf('SVM_Workspace_Run%d_LOOP.mat',rr);

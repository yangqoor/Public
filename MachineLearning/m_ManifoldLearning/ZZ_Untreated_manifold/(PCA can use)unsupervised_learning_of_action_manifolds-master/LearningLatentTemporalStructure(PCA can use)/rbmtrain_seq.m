...
% opts.batch_size
function rbm = rbmtrain_seq(rbm,X,opts,flag_seq)
...
%     end
    ...
    for l = 1:1:numbatches
        ...
        prob_Hj_V_pos = 1./(1 + exp( -1 * (v0 * rbm.W' + repmat(rbm.bh',num_images_per_batch,1))));
        ...
        pos_Hj_states = (prob_Hj_V_pos > rand(num_images_per_batch,num_hid));
        ...
        prob_Hj_V_neg = 1./(1 + exp( -1 * (v1 * rbm.W' + repmat(rbm.bh',num_images_per_batch,1))));

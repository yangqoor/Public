...
C1 = 2.05; %options.CognitiveAttraction ; % Local (self best point)
C2 = 2.05; %options.SocialAttraction ; % Global (overall best point)
Chi = .72984;
...
state.Velocities = Chi.*(state.Velocities + ...

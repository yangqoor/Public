...
function [ x  YtrueMinusEstTotal shapeModeParams] = tuneLambdaSigmaSkipDensity(  maskFileFolder, ...
                        nFold, X, Y, W0, M,...
    ...
    [ nX Yw yMu V D Vimg V1 D1 yMu1 xMu Dimg] = normalizeDataUltimate( tempShapeModelFile, ...

...
function [ nX Yw yMu V D Vimg V1 D1 yMu1 xMu Dimg ] = normalizeDataMOG( parameterFile, X , Y,  ...
                     trainThis, doItFast, imgFeatureMode, imageDimensions, ...
                     calcM, shapeVersion, mode3D, shapePercent, subShapeCoords) 
...
%------------------------
imagePercent = .99;
% shapePercent = .90;      %.99 % for PR experiments, .9 for ADA
...
% standardize shapes using  PCA-like model
    ...
    [ yMu V D Yw V1 D1 yMu1  ] = parameterizeShape( Y, doItFast, parameterFile, ...
                                        trainThis, shapePercent, shapeVersion, ...
                                        mode3D, subShapeCoords );

function landmark = farthest_landmark_sampling( W, landmark, DL_landmark, base_points, DL_base, nbr_points )

% farthest_landmark_sampling - samples landmark using least error seeding strategy
%
% points = farthest_landmark_sampling( W, points, nbr_points, DL, base_points );
%
%   points can be []
...
for i=1:nbr_points
    ...
    for k=1:nbr_trial
        ...
        D = perform_fast_marching_2d(W, trial(:,k));
